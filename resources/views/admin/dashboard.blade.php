...
<body class="d-flex flex-column min-vh-100">
        ...
        <div class="container-fluid d-flex align-items-center p-3" style="background: rgb(22, 22, 29);">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav  me-auto mb-2 mb-lg-0">
                    ...
                    <li>
                        <a class="nav-link" href="{{ route('kategoriTampil') }}">Kategori</a>
                    </li>
                    <li>
                        <a class="nav-link" href="{{ route('kantinTampil') }}">Kantin</a>
                    </li>
                    <li>
                        <a class="nav-link" href="{{ route('aulaTampil') }}">Aula</a>
                    </li>
                </ul>
    ...
    <div class="container m-auto" style="background:white">
